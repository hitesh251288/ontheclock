...
if (sqlsrv_num_rows($result) > 0) { //echo "If";die;
...
//echo "Hey";die;
	...
	$getData = "SELECT * FROM dbo.attendance_rawlog order by TDate desc LIMIT 4000";
...
//die;
	...
	$sql = "INSERT INTO dbo.attendance_rawlog ( e_id, Emp_id, Name, Emp_code, Dept, Div_Desg, Rmk, Tshift, Tdate, Time, Terminal) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	//$sql = "INSERT INTO dbo.attendance_rawlog ( e_id, Emp_id, Name, Emp_code, Dept, Div_Desg, Rmk, Tshift, Tdate, Time, Terminal) VALUES ('".$dayMasterAllData[1]."', '".$dayMasterAllData[8]."', '".$dayMasterAllData[6]."', '".$dayMasterAllData[7]."', '".$dayMasterAllData[9]."', '".$dayMasterAllData[10]."', '".$dayMasterAllData[11]."', '".$dayMasterAllData[13]."', '".$dayMasterAllData[2]."', '".$dayMasterAllData[3]."', '".$dayMasterAllData[14]."')";
	//echo "<br>";
