...
/**************/
// Check if the column 'EmpClose' exists in the 'tgroup' table  
$checkQuery = "SELECT COLUMN_NAME   
               FROM INFORMATION_SCHEMA.COLUMNS   
               WHERE TABLE_NAME = 'tgroup' AND COLUMN_NAME = 'EmpClose' AND TABLE_SCHEMA = 'access'";  

$checkResult = mysqli_query($conn, $checkQuery);  

// If the column does not exist, add it  
if (mysqli_num_rows($checkResult) == 0) {  
    $clsQuery = "ALTER TABLE tgroup ADD COLUMN EmpClose VARCHAR(4) NOT NULL";  
    if (mysqli_query($conn, $clsQuery)) {  
        echo "Column 'EmpClose' added successfully.";  
    } else {  
        echo "Error adding column: " . mysqli_error($conn);  
    }  
} 

//$colquery = "SELECT EmpClose from tgroup";
//$colResult = mysqli_query($conn, $colquery);
//if(!$colResult){
//    $clsQuery = "ALTER TABLE tgroup ADD COLUMN EmpClose VARCHAR(4) NOT NULL";
//    mysqli_query($conn, $clsQuery);
//}
/**************/
if ($prints != "yes") {
    include 'header.php';
...
<div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Shift Settings - Summary</h4>
                            <div class="ms-auto text-end">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">
                                            Shift Settings - Summary
                                        </li>
                                    </ol>
                                </nav>
                            </div>
...
//    echo "<pre>";print_R($cur);
    ...
    print "<td class='f2'><input size='4' name='txtEmpClose" . $c_shift . "' value='" . $cur[39] . "' class='form-control-inner'></td>";
    print "</tr>";
}
...
if (stripos($userlevel, $current_module . "D") !== false) {
    print "<p align='center'><input type='submit' class='btn btn-primary' value='Save Changes'></p>";
}
print "</p></form>";
//echo "\r\n</center>";
