        ...
        if ($main_result[1] == "Payroll DB") {
            ...
            if ($main_result[13] == "PayMaster" || $main_result[13] == "WebPayMaster") {
                ...
                if (getRegister($txtMACAddress, 7) == "39") {
                    ...
                    if (getRegister($txtMACAddress, 7) == "57" || getRegister($txtMACAddress, 7) == "58" || getRegister($txtMACAddress, 7) == "59" || getRegister($txtMACAddress, 7) == "60" || getRegister($txtMACAddress, 7) == "82" || getRegister($txtMACAddress, 7) == "103" || getRegister($txtMACAddress, 7) == "117") {
