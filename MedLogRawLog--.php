...
//$result = sqlsrv_query($connectSQL,$query);
if (sqlsrv_num_rows($result) > 0) { 
	...
	$getData = "SELECT * FROM dbo.medlog_rawlog";
	...
	//$sql = "INSERT INTO dbo.medlog_rawlog ( e_id, Genesis_id, Name, Emp_code, Dept, Div_Desg, Rmk, Tshift, Tdate, Time, Terminal) VALUES ( '".$dayMasterAllData[1]."', '".$dayMasterAllData[8]."', '".$dayMasterAllData[6]."', '".$dayMasterAllData[7]."', '".$dayMasterAllData[9]."','".$dayMasterAllData[10]."', '".$dayMasterAllData[11]."', '".$dayMasterAllData[13]."', '".$dayMasterAllData[2]."', '".$dayMasterAllData[3]."', '".$dayMasterAllData[14]."')";
	//echo "<br>";
	//$Medresult = sqlsrv_query($connectSQL, $sql);
	//$Medresult = mssql_query($sql,$oconn);
	/*if($Medresult){
		echo "<br>";
