...
if (!checkSession($userlevel, $current_module)) {
    header("Location: " . $config["REDIRECT"] . "?url=EmployeeWiseOffDay.php&message=Session Expired or Security Policy Violated");
}
$conn = openConnection();
...
print "<form name='frm1' method='post' onSubmit='return checkSearch()' action='EmployeeWiseOffDay.php'><input type='hidden' name='act' value='searchRecord'>";
if ($prints != "yes") {
//    print "<body>";
...
//            echo "<pre>";print_R($flag_result[3]);
