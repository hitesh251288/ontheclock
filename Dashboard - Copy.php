...
//$current_date = date("Ymd");
$current_date = '20240610';
//$current_date = '20190821';
...
if (isset($_POST['submit']) && !empty($_POST['lstShift'])) {
    ...
    $querytotal = "SELECT tuser.id FROM tuser, tgroup WHERE tuser.group_id = tgroup.id " . $_SESSION[$session_variable . "DeptAccessQuery"] . " "
            . "AND tgroup.id = " . $lstShift . " AND tuser.PassiveType = '" . $lstEmployeeStatus . "' GROUP BY tuser.id ORDER BY tuser.id";
    $resulttotal = mysqli_query($conn, $querytotal);
    $row_cnt = $resulttotal->num_rows;
    ...
    $querypresent = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, "
            ...
            . "AND tgroup.id = " . $lstShift . " AND tuser.id NOT IN (SELECT e_id FROM FlagDayRotation WHERE e_date = '" . $current_date . "')
            AND tenter.e_date = '" . $current_date . "' AND tuser.PassiveType = '" . $lstEmployeeStatus . "'  "
    ...
    $queryabsent = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, tuser.idno, "
            ...
            . "(tuser.UserStatus > 5 OR (tuser.UserStatus = 5 AND tuser.id = 'admin')) AND tgroup.id = " . $lstShift . " "
    ...
    $queryleave = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, "
            ...
            . "tuser.F1, tuser.F2, tuser.F3, tuser.F4, tuser.F5, tuser.F6, tuser.F7, tuser.F8, "
            . "tuser.F9, tuser.F10 FROM tuser, tgroup, " . $table_name . ", tgate "
            . "WHERE tuser.group_id = tgroup.id AND " . $table_name . ".e_id = tuser.id AND tgroup.id = " . $lstShift . " "
            . "AND " . $table_name . ".g_id = tgate.id " . $_SESSION[$session_variable . "DeptAccessQuery"] . " " . $_SESSION[$session_variable . "DivAccessQuery"] . "  "
            . "AND " . $table_name . ".e_date  >= '" . $current_date . "' AND " . $table_name . ".e_date  <= '" . $current_date . "' AND "
            . "tuser.PassiveType = '" . $lstEmployeeStatus . "'";
    $resultleave = mysqli_query($conn, $queryleave);
    ...
    $querylate = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, "
            ...
            . "tuser.F5, tuser.F6, tuser.F7, tuser.F8, tuser.F9, tuser.F10 FROM tuser, "
            . "tgroup, tenter, tgate WHERE tenter.e_group = tgroup.id AND tenter.e_id = tuser.id "
            . "AND tgroup.GraceTo <= tenter.e_time AND tenter.g_id = tgate.id  AND tgroup.id = " . $lstShift . " AND "
            . "tgate.exit = 0 " . $_SESSION[$session_variable . "DeptAccessQuery"] . " " . $_SESSION[$session_variable . "DivAccessQuery"] . "  "
            . "AND tenter.e_date = '" . $current_date . "' AND tuser.PassiveType = '" . $lstEmployeeStatus . "' ORDER BY tuser.id, tenter.e_date, tenter.e_time";
    ...
    $queryEarlyexit = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, "
            ...
            . "WHERE tenter.e_id = tuser.id AND tenter.g_id = tgate.id AND tgate.exit = 1) "
            . "AND ((tenter.e_time < '240000' AND tgroup.NightFlag =0) OR "
            . "(tenter.e_time < '" . $NightShiftMaxOutTime . "00' AND tgroup.NightFlag = 1)) AND tgroup.id = " . $lstShift . " "
            . "AND tenter.e_date = '" . $current_date . "' AND tuser.PassiveType = '" . $lstEmployeeStatus . "'";
...
$genderQuery = "SELECT idno, COUNT(*) as count FROM tuser GROUP BY idno";
...
$categoryQuery = "SELECT remark, COUNT(*) as count FROM tuser where PassiveType='ACT' GROUP BY remark ORDER BY count DESC";
...
$statusQuery = "SELECT PassiveType, COUNT(*) as count FROM tuser GROUP BY PassiveType ORDER BY count DESC";
...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xlg-4">
                    <div class="card card-hover">
                        <select class="select2 form-select shadow-none select2-hidden-accessible" name="lstShift" >
                            <option value="">---</option>
                            <?php
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportEmployee.php" target="_blank">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportAttendance.php" target="_blank">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportAbsence.php" target="_blank">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportLateArrival.php" target="_blank">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportEarlyExit.php" target="_blank">
        ...
        <div class="col-md-6 col-lg-2 col-xlg-3">
            <div class="card card-hover">
                <a href="ReportPreFlag.php" target="_blank">
                    <div class="box bg-danger text-center">
                        <h1 class="font-light text-white">
                            <i class="mdi mdi-arrow-all"></i>
                        </h1>
...
<script>
    ...
    /***********Division Wise Attendance***********/
    $(document).ready(function () {
        var jsonData = <?php echo json_encode($divs); ?>;
    ...
    const datagen = {
        ...
        datasets: [{
                ...
                borderWidth: 2,
                pointBackgroundColor: ['#36A2EB', '#FF6384'], // Points colors
                pointBorderColor: ['#36A2EB', '#FF6384'],
                pointHoverBackgroundColor: ['#36A2EB', '#FF6384'],
                pointHoverBorderColor: ['#36A2EB', '#FF6384']
            }]
    };
