...
//                    echo $query = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, tenter.e_date, tenter.e_time, tgate.name, tuser.idno, tuser.remark, tuser.phone,attendancemaster.Break, attendancemaster.EarlyOut FROM tuser, tgroup, tenter, tgate ,attendancemaster WHERE attendancemaster.EmpID=tuser.id AND tenter.e_group = tgroup.id AND tenter.e_id = tuser.id AND tenter.g_id = tgate.id AND tgate.exit = 0 AND ((tenter.e_time > '" . $cutoff . "00' AND tgroup.NightFlag = 1) OR (tenter.e_time > '000000' AND tgroup.NightFlag = 0)) " . $_SESSION[$session_variable . "DeptAccessQuery"] . " " . $_SESSION[$session_variable . "DivAccessQuery"] . " ";
                    $query = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tuser.idno, attendancemaster.Break, attendancemaster.EarlyOut ,tuser.remark ,attendancemaster.ADate FROM tuser INNER JOIN attendancemaster ON attendancemaster.EmpID=tuser.id AND attendancemaster.ADate BETWEEN '" . insertDate($txtFrom) . "'  AND '" . insertDate($txtTo) . "' ";
                    ...
                    $query = $query . " AND tuser.PassiveType = 'ACT' ORDER BY tuser.id,attendancemaster.ADate";
//                    if ($lstShift != "") {
//                        echo $query = $query . " AND tgroup.id = " . $lstShift;
//                    }
//                    if ($lstTerminal != "") {
//                        echo $query = $query . " AND tenter.g_id = " . $lstTerminal;
//                    }
...
//                    if ($lstFlag == "No") {
//                        echo $query = $query . " AND tuser.id NOT IN (SELECT e_id FROM FlagDayRotation WHERE e_date = " . $date_count . ") ";
//                    }
//                    if ($date_count != "") {
//                        echo $query = $query . " AND tenter.e_date = '" . $date_count . "'";
//                    }
////                    echo $query = queryClockingType($query, $lstClockingType);
//                    echo $query = $query . employeeStatusQuery($lstEmployeeStatus);
//                    echo $query = $query . " ORDER BY " . $lstSort;
                    ...
                    if (0 < count(mysqli_num_rows($result))) {
                        ...
                        print "<tr><td><font face='Verdana' size='2'>ID</font></td> <td><font face='Verdana' size='2'>Name</font></td> <td><font face='Verdana' size='2'>" . $_SESSION[$session_variable . "IDColumnName"] . "</font></td> <td><font face='Verdana' size='2'>Dept</font></td> <td><font face='Verdana' size='2'>Div/Desg</font></td> <td><font face='Verdana' size='2'>Rmk</font></td> <td><font face='Verdana' size='2'>Shift</font></td> <td><font face='Verdana' size='2'>Date</font></td><td><font face='Verdana' size='2'>Total Out Hours</font></td>";
                        ...
                        print "</tr>";
                        while ($cur = mysqli_fetch_row($result)) {
                            $TotalOutHours = ($cur['5'] + $cur['6']) / 3600;
                            print "<tr><td><a title='ID'><input type='hidden' name='txh" . $count . "' value='" . $cur[0] . "'><font face='Verdana' size='1'>" . addZero($cur[0], $_SESSION[$session_variable . "EmployeeCodeLength"]) . "</font></a></td> <td><a title='Name'><font face='Verdana' size='1'>" . $cur[1] . "</font></a></td> <td><a title='Sex'><font face='Verdana' size='1'>" . $cur[4] . "</font></a></td> <td><a title='Dept'><font face='Verdana' size='1'>" . $cur[2] . "</font></a></td> <td><a title='Dev/Desg'><font face='Verdana' size='1'>" . $cur[3] . "</font></a></td> <td><a title='Rmk'><font face='Verdana' size='1'>" . $cur[7] . "</font></a></td> <td><a title='Shift'><font face='Verdana' size='1'>" . $cur[4] . "</font></a></td> <td><a title='Date'><font face='Verdana' size='1'>" . displayDate($cur[8]) . "</font></a></td><td><a title='Terminal'><font face='Verdana' size='1'>" . round($TotalOutHours) . "</font></a></td>";
                            if (!($cur[0] == $last_id && $cur[5] == $last_date)) {
                                if ($cur[3] == "") {
                                    $cur[3] = "&nbsp;";
                                }
                                ...
                                displayDate($cur[5]);
                                displayVirdiTime($cur[6]);
//                                print "<tr><td><a title='ID'><input type='hidden' name='txh" . $count . "' value='" . $cur[0] . "'><font face='Verdana' size='1'>" . addZero($cur[0], $_SESSION[$session_variable . "EmployeeCodeLength"]) . "</font></a></td> <td><a title='Name'><font face='Verdana' size='1'>" . $cur[1] . "</font></a></td> <td><a title='Normal'><font face='Verdana' size='1'>" . $cur[8] . "</font></a></td> <td><a title='Dept'><font face='Verdana' size='1'>" . $cur[2] . "</font></a></td> <td><a title='Dev/Desg'><font face='Verdana' size='1'>" . $cur[3] . "</font></a></td> <td><a title='Rmk'><font face='Verdana' size='1'>" . $cur[9] . "</font></a></td> <td><a title='Shift'><font face='Verdana' size='1'>" . $cur[4] . "</font></a></td> <td><a title='Date'><font face='Verdana' size='1'>" . displayDate($cur[5]) . "</font></a></td> <td><a title='Time'><font face='Verdana' size='1'>" . displayVirdiTime($cur[6]) . "</font></a></td> <td><a title='Terminal'><font face='Verdana' size='1'>" . $cur[7] . "</font></a></td><td><a title='Terminal'><font face='Verdana' size='1'>" . $TotalOutHours . "</font></a></td>";
                                if ($_SESSION[$session_variable . "VirdiLevel"] == "Meal") {
