...
if ($act == "searchRecord") {
    ...
    if ($lstType == "") {
        if ($lstGroupBy == "Dept") {
            ...
            print "<tr><td><font face='Verdana' size='1'>&nbsp;</font></td><td><font face='Verdana' size='1'>&nbsp;</font></td><td><font face='Verdana' size='1'>&nbsp;</font></td><td><font face='Verdana' size='1'>&nbsp;</font></td><td><font face='Verdana' size='1'>&nbsp;</font></td><td><font face='Verdana' size='1'>&nbsp;</font></td>";
        }
        for ($i = 0; $i < count($dateFromArray); $i++) {
    ...
    for ($t5 = 0; $main_cur = mysqli_fetch_row($main_result); $row_count++) {
        if ($lstGroupBy == "Dept") {
            ...
            for ($i = 0; $i < count($dateFromArray); $i++) {
                ...
                displayDate($dateToArray[$i]);
                addComma(round($result[0] / 3600, 2));
                print "<td><a title='Approved OT on Purple Flag (Public Holidays) [" . displayDate($dateFromArray[$i]) . " - " . displayDate($dateToArray[$i]) . "]'><font face='Verdana' size='1' color='Purple'>" . addComma(round($result[0] / 3600, 2)) . "</font></a></td>";
                $t5 = $t5 + $result[0];
            }
        } else {
                                        ...
                                        if ($lstType == "Grace") {
                                            ...
                                            if ($lstType == "OT") {
                                                ...
                                                if ($lstType == "Approved OT") {
                                                    ...
                                                    displayDate($dateToArray[$i]);
                                                    round($result[0] / 3600, 2);
                                                    print "<td><a title='Approved OT on Sundays [" . displayDate($dateFromArray[$i]) . " - " . displayDate($dateToArray[$i]) . "]'><font face='Verdana' size='1'>" . round($result[0] / 3600, 2) . "</font></a></td>";
                                                    $t4 = $t4 + $result[0];
