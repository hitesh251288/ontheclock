...
if (!checkSession($userlevel, $current_module)) {
    header("Location: " . $config["REDIRECT"] . "?url=EmployeeDailyAttendanceReport.php&message=Session Expired or Security Policy Violated");
}
$conn = openConnection();
$act = $_GET["act"];
if ($act == "") {
...
<div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Employee Daily Attendance Report</h4>
...
//            print "<tr><td>&nbsp;</td><td><font face='Verdana' size='1'><b>Selected Options</b></font></td></tr>";
        ...
        <div class="row">
            ...
            <div class="col-2">
                <?php 
                print "<label class='form-label'>Include Flagged Employees:</label>";
                if ($prints != "yes") {
                    print "<select name='lstFlag' class='form-select select2 shadow-none'> <option selected value='" . $lstFlag . "'>" . $lstFlag . "</option> <option value='Yes'>Yes</option> <option value='No'>No</option> </select>";
                } else {
...
//                    $query = "SELECT tuser.id, tuser.name, tuser.dept, tuser.company, tgroup.name, tenter.e_date, MIN(tenter.e_time) as InTime,MAX(tenter.e_time) as OutTime, tgate.name, tuser.idno, tuser.remark, tuser.phone, tgroup.Start, tgroup.Close FROM tuser, tgroup, tenter, tgate WHERE tenter.e_group = tgroup.id AND tenter.e_id = tuser.id AND tenter.g_id = tgate.id AND tgate.exit = 0 AND ((tenter.e_time > '" . $cutoff . "00' AND tgroup.NightFlag = 1) OR (tenter.e_time > '000000' AND tgroup.NightFlag = 0)) " . $_SESSION[$session_variable . "DeptAccessQuery"] . " " . $_SESSION[$session_variable . "DivAccessQuery"] . " ";
                    ...
                    if ($date_count != "") {
                       $query = $query . " AND tenter.e_date >= '" . insertDate($txtFrom) . "' AND tenter.e_date <= '" . insertDate($txtTo) . "' GROUP BY tuser.id,tenter.e_date";
                    }
                    ...
                    $page_count = 1;
                    if (0 < mysqli_num_rows($result)) {                        
//                        print "<tr><td><font face='Verdana' size='1'>&nbsp;</font></td> <td><font face='Verdana' size='1'>&nbsp;</font></td> <td><font face='Verdana' size='1'>&nbsp;</font></td> <td><font face='Verdana' size='1'>&nbsp;</font></td> <td><font face='Verdana' size='1'>&nbsp;</font></td></tr>";
//                        print "<tr><td><font face='Verdana' size='2'>ID</font></td> <td><font face='Verdana' size='2'>Name</font></td> <td><font face='Verdana' size='2'>" . $_SESSION[$session_variable . "IDColumnName"] . "</font></td> <td><font face='Verdana' size='2'>Dept</font></td> <td><font face='Verdana' size='2'>Div/Desg</font></td> <td><font face='Verdana' size='2'>Rmk</font></td> <td><font face='Verdana' size='2'>Shift</font></td> <td><font face='Verdana' size='2'>Date</font></td> <td><font face='Verdana' size='2'>InTime</font></td><td><font face='Verdana' size='2'>OutTime</font></td> <td><font face='Verdana' size='2'>Total Hours Worked</font></td>";
//                        print "<tr><td><font face='Verdana' size='2'>Date</font></td><td><font face='Verdana' size='2'>WeekDays</font></td><td><font face='Verdana' size='2'>InTime</font></td><td><font face='Verdana' size='2'>OutTime</font></td><td><font face='Verdana' size='2'>Remarks</font></td>";
...
//                                            echo "<br>";
                                            ...
                                            if ($cur[0] !== $last_id) { 
                                                    if($last_id !== ""){
//                                                        echo "<tr class='employee_row' data-employee-id='$cur[0]'>";
                                                        print "<table class='employee_row table table-striped table-bordered dataTable' width='800' border='1' cellpadding='1' bordercolor='#C0C0C0' cellspacing='-1'><tr><td colspan='2'>" . date('d/m/Y') . "</td><td colspan='4'>" . addZero($cur[0], $_SESSION[$session_variable . "EmployeeCodeLength"]) ."-".$cur[1] . "</td></tr>";
                                                        print "<tr><td><font face='Verdana' size='2'>Date</font></td><td><font face='Verdana' size='2'>WeekDays</font></td><td><font face='Verdana' size='2'>InTime</font></td><td><font face='Verdana' size='2'>OutTime</font></td><td><font face='Verdana' size='2'>Remarks</font></td>";
//                                                        print "</tr>";
                                                    }else{
                                                        print "<table class='employee_row table table-striped table-bordered dataTable' width='800' border='1' cellpadding='1' bordercolor='#C0C0C0' cellspacing='-1'><tr><td colspan='2'>" . date('d/m/Y') . "</td><td colspan='4'>" . addZero($cur[0], $_SESSION[$session_variable . "EmployeeCodeLength"]) ."-".$cur[1] . "</td></tr>";    
...
//                                                        print "</tr>";
                                            ...
                                            print "<tr><td><a title='Date'><font face='Verdana' size='1'>" . displayDate($cur[5]) . "</font></a></td><td><a title='Date'><font face='Verdana' size='1'>" . date('l',strtotime(displayDate($cur[5]))) . "</font></a></td><td><a title='Time'><font face='Verdana' size='1'>" . displayVirdiTime($cur[6]) . "</font></a></td> <td><a title='OutTime'><font face='Verdana' size='1'>" . displayVirdiTime($cur[7]) . "</font></a></td><td><a title='Rmk'><font face='Verdana' size='1'>" . $cur[10] . "</font></a></td>";
...
<style>
    @media print {
      .employee_row { 
        page-break-inside: avoid; /* Prevent breaks inside tables */
        page-break-after: always; /* Force new page after each table */
      }
    }
