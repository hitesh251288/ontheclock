...
if ($act == "searchRecord") {
    ...
    if ($lstReportType == "Custom3") {
        ...
        if ($lstReportType != "Custom1" && $lstReportType != "Custom6") {
            if ($csv != "yes") {
    ...
    if ($lstReportType != "Custom1" && $lstReportType != "Custom3") {
        if ($csv != "yes") {
            print "<tr>";
        }
        if ($lstReportType == "Custom2") {
    ...
    if (strpos($ras, "-TLD-") !== false && $lstReportType != "Custom5" && $lstReportType != "Custom3") {
