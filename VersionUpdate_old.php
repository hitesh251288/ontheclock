...
function V3958120221($conn, $iconn) { //echo "Hi";die;
    global $mac_in_version;
    createTrigger($iconn, $mac_in_version, 2);
...
function V3552116202($conn, $iconn) {
    ...
    if ($this_conn != "") {
        ...
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_am CHANGE Remark Remark VARCHAR( 1024 ) DEFAULT NULL";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_trans CHANGE Transactquery Transactquery VARCHAR( 1024 ) DEFAULT NULL";
        safeUpdateIData($this_conn, $query, true);
        ...
        $query = "ALTER TABLE AccessArchive.archive_trans CHANGE Transactquery Transactquery VARCHAR( 1024 ) DEFAULT NULL";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.FlagDayRotation CHANGE Remark Remark VARCHAR( 1024 ) NULL, CHANGE OT1 OT1 VARCHAR( 10 ) NULL, CHANGE OT2 OT2 VARCHAR( 10 ) NULL, CHANGE Flag Flag VARCHAR( 10 ) NULL ";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_am CHANGE Flag Flag VARCHAR( 10 ) NULL DEFAULT 'Black', CHANGE OT1 OT1 VARCHAR( 255 ) NULL DEFAULT 'Saturday', CHANGE OT2 OT2 VARCHAR( 255 ) NULL DEFAULT 'Sunday' ";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_dm CHANGE Flag Flag VARCHAR( 10 ) NULL DEFAULT 'Black' ";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_trans CHANGE Username Username VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE Transactquery Transactquery VARCHAR( 1024 ) NULL ";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE AccessArchive.archive_am CHANGE Remark Remark VARCHAR( 1024 ) NULL , ADD PHF INT ( 1 ) NOT NULL DEFAULT 0 ";
        safeUpdateIData($this_conn, $query, true);
        $query = "ALTER TABLE Access.AttendanceMaster CHANGE Remark Remark VARCHAR( 1024 ) NULL ";
        safeUpdateIData($this_conn, $query, true);
...
function V3443110182($conn) { 
    $query = "ALTER TABLE access.tuser CHANGE group_id group_id INT(20) NULL DEFAULT '0'";
    safeUpdate($conn, $query, true);
    V3443110183($conn);
}
...
//    safeUpdate($conn, $query, true);
//    $query = "ALTER TABLE Access.tenter CHANGE ed ed int( 10 ) NOT NULL AUTO_INCREMENT";
//    safeUpdate($conn, $query, true);
//    V3442110181($conn);
//}
...
function V3239107176($conn) {
    $query = "ALTER TABLE  access.payrollmap CHANGE  DataCOMPayroll DataCOMPayroll VARCHAR( 255 ) NOT NULL DEFAULT  'No' ";
    safeUpdate($conn, $query, true);
    V3340108177($conn);
}
...
function V3135100165($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.UserMaster CHANGE UserStatus UserStatus INT NOT NULL DEFAULT '5' ";
    safeUpdate($conn, $query, true);
...
function V313097158($conn) {
    $query = "ALTER TABLE access.OtherSettingMaster CHANGE NoExitException NoExitException VARCHAR(50) NULL DEFAULT 'No' ";
    safeUpdate($conn, $query, true);
    V313198159($conn);
}
...
function V302994154($conn) {
    $query = "ALTER TABLE access.FlagTitle ADD FlagLink VARCHAR(255) DEFAULT NULL, CHANGE Title Title VARCHAR(255) DEFAULT NULL";
    safeUpdate($conn, $query, true);
...
//    $result = safeUpdateIData($iconn, $query, true);
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.FlagDayRotation CHANGE OT1 OT1 INT DEFAULT NULL, CHANGE OT2 OT2 INT DEFAULT NULL";
    safeUpdate($conn, $query, true);
...
function V302892151($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.FlagDayRotation CHANGE group_id group_id INT(11) DEFAULT " . $shift;
    safeUpdate($conn, $query, true);
...
function V302890148($conn) {
    ...
    $query = "ALTER TABLE AccessArchive.FlagDayRotation CHANGE Remark Remark VARCHAR( 1024 ) NULL, CHANGE OT1 OT1 VARCHAR( 10 ) NULL, CHANGE OT2 OT2 VARCHAR( 10 ) NULL, CHANGE Flag Flag VARCHAR( 10 ) NULL ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE archive_am CHANGE Flag Flag VARCHAR( 10 ) NULL DEFAULT 'Black', CHANGE OT1 OT1 VARCHAR( 255 ) NULL DEFAULT 'Saturday', CHANGE OT2 OT2 VARCHAR( 255 ) NULL DEFAULT 'Sunday' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE archive_dm CHANGE Flag Flag VARCHAR( 10 ) NULL DEFAULT 'Black' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE archive_trans CHANGE Username Username VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE Transactquery Transactquery VARCHAR( 1024 ) NULL ";
    safeUpdate($conn, $query, true);
    V302891149($conn);
}
...
function V292687142($conn) {
    $query = "ALTER TABLE access.AttendanceMaster CHANGE Remark Remark VARCHAR( 1024 ) NOT NULL DEFAULT '' ";
    safeUpdate($conn, $query, true);
...
function V292686141($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.tgroup CHANGE StartHour StartHour VARCHAR( 4 ) NOT NULL DEFAULT '0000' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.tgroup CHANGE CloseHour CloseHour VARCHAR( 4 ) NOT NULL DEFAULT '2359' ";
    safeUpdate($conn, $query, true);
...
function V292483137($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.tgroup CHANGE StartHour StartHour DECIMAL( 5, 2 ) NOT NULL DEFAULT '0', CHANGE CloseHour CloseHour DECIMAL( 5, 2 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    V292584138($conn);
}
...
function V221772110($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.employeeflag CHANGE Violet Violet INT( 5 ) NOT NULL DEFAULT '365', CHANGE Indigo Indigo INT( 5 ) NOT NULL DEFAULT '365', CHANGE Blue Blue INT( 5 ) NOT NULL DEFAULT '365', CHANGE Green Green INT( 5 ) NOT NULL DEFAULT '365', CHANGE Yellow Yellow INT( 5 ) NOT NULL DEFAULT '365', CHANGE Orange Orange INT( 5 ) NOT NULL DEFAULT '365', CHANGE Red Red INT( 5 ) NOT NULL DEFAULT '365', CHANGE Gray Gray INT( 5 ) NOT NULL DEFAULT '365', CHANGE Brown Brown INT( 5 ) NOT NULL DEFAULT '365', CHANGE Purple Purple INT( 5 ) NOT NULL DEFAULT '365' ";
    safeUpdate($conn, $query, true);
...
function V19136983($conn) {
    $query = "ALTER TABLE access.tuser CHANGE name name VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE idno idno VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE dept dept VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE company company VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE phone phone VARCHAR( 255 ) NULL DEFAULT NULL , CHANGE remark remark VARCHAR( 255 ) NULL DEFAULT NULL ";
    safeUpdate($conn, $query, true);
...
function V1576060($conn) {
    ...
    safeUpdate($conn, $query, true);
    mysqli_query($conn, "UPDATE access.OtherSettingMaster SET FlagReportText = '' WHERE FlagReportText IS NULL");
    $query = "ALTER TABLE access.OtherSettingMaster CHANGE FlagReportText RosterColumns VARCHAR( 1024 ) NOT NULL COMMENT 'Roster Report Column Selection' ";
    safeUpdate($conn, $query, true);
...
function V1265957($conn) {
    $query = "ALTER TABLE access.ProcessLog CHANGE PType PType VARCHAR( 255 ) NULL DEFAULT NULL";
    safeUpdate($conn, $query, true);
...
function V1265849($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.Usermaster CHANGE RASSelection RASSelection VARCHAR( 1024 ) NOT NULL DEFAULT '-V--I--B--G--Y--O--R--GR--BR--PR--BK--WKD--PXY--FLG--SAT--SUN--TLD--NS--NF--TND--WKH--PXH--FLH--SATH--SUNH--TLH--NSH--NFH--TNH-'";
    safeUpdate($conn, $query, true);
...
function V1265543($conn) {
    $query = "ALTER TABLE access.attendancemaster CHANGE Flag Flag VARCHAR(10) NOT NULL DEFAULT 'Black'";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.daymaster CHANGE Flag Flag VARCHAR(10) NOT NULL DEFAULT 'Black'";
    safeUpdate($conn, $query, true);
    $query = "UPDATE access.tenter SET e_group = 0 WHERE e_group IS NULL";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE access.tenter CHANGE e_group e_group SMALLINT(5) NOT NULL DEFAULT '0'";
    safeUpdate($conn, $query, true);
...
function V1265542($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.alterlog CHANGE ed ed INT( 10 ) NOT NULL DEFAULT '0', CHANGE GateFrom GateFrom INT( 10 ) NOT NULL DEFAULT '0', CHANGE GateTo GateTo INT( 10 ) NOT NULL DEFAULT '0', CHANGE TransactDate TransactDate INT( 10 ) NOT NULL DEFAULT '0', CHANGE ShiftFrom ShiftFrom INT( 10 ) NOT NULL DEFAULT '0', CHANGE ShiftTo ShiftTo INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "UPDATE Access.AttendanceMaster SET Week = 0 WHERE Week IS NULL";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.attendancemaster CHANGE EmployeeID EmployeeID INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_min group_min INT( 10 ) NOT NULL DEFAULT '0', CHANGE ADate ADate INT( 10 ) NOT NULL DEFAULT '0', CHANGE Week Week INT( 10 ) NOT NULL DEFAULT '0', CHANGE EarlyIn EarlyIn INT( 10 ) NOT NULL DEFAULT '0', CHANGE LateIn LateIn INT( 10 ) NOT NULL DEFAULT '0', CHANGE Break Break INT( 10 ) NOT NULL DEFAULT '0', CHANGE LessBreak LessBreak INT( 10 ) NOT NULL DEFAULT '0', CHANGE MoreBreak MoreBreak INT( 10 ) NOT NULL DEFAULT '0', CHANGE EarlyOut EarlyOut INT( 10 ) NOT NULL DEFAULT '0', CHANGE LateOut LateOut INT( 10 ) NOT NULL DEFAULT '0', CHANGE Normal Normal INT( 10 ) NOT NULL DEFAULT '0', CHANGE Grace Grace INT( 10 ) NOT NULL DEFAULT '0', CHANGE Overtime Overtime INT( 10 ) NOT NULL DEFAULT '0', CHANGE AOvertime AOvertime INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.daymaster CHANGE e_id e_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE TDate TDate INT( 10 ) NOT NULL DEFAULT '0', CHANGE LastDayMasterID LastDayMasterID INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE Work Work INT( 11 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.deptgate CHANGE g_id g_id INT( 10 ) NOT NULL DEFAULT '0'";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.logmaster CHANGE LogDate LogDate INT( 10 ) NOT NULL DEFAULT '0', CHANGE ed ed INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.processlog CHANGE PDate PDate INT( 10 ) NOT NULL DEFAULT '0'";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.othersettingmaster CHANGE MinClockinPeriod MinClockinPeriod INT( 10 ) NOT NULL DEFAULT '0', CHANGE TotalDailyClockin TotalDailyClockin INT( 10 ) NOT NULL DEFAULT '0', CHANGE NightShiftMaxOutTime NightShiftMaxOutTime INT( 10 ) NOT NULL DEFAULT '0', CHANGE TotalExitClockin TotalExitClockin INT( 10 ) NOT NULL DEFAULT '0', CHANGE RotateShiftNextDay RotateShiftNextDay INT( 10 ) NOT NULL DEFAULT '0', CHANGE Ex3 Ex3 INT( 10 ) NOT NULL DEFAULT '0', CHANGE Ex4 Ex4 INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.projectlog CHANGE DayMasterID DayMasterID INT( 10 ) NOT NULL DEFAULT '0', CHANGE WeekMasterID WeekMasterID INT( 10 ) NOT NULL DEFAULT '0', CHANGE ProjectID ProjectID INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_id e_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_date e_date INT( 10 ) NOT NULL DEFAULT '0', CHANGE twork twork INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.proxydelete CHANGE e_id e_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_date e_date INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE g_id g_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE ed ed INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.shiftchangemaster CHANGE id id INT( 10 ) NOT NULL DEFAULT '0'";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.shiftrotatelog CHANGE RDate RDate INT( 10 ) NOT NULL DEFAULT '0', CHANGE RTime RTime INT( 10 ) NOT NULL DEFAULT '0', CHANGE ShiftFrom ShiftFrom INT( 10 ) NOT NULL DEFAULT '0', CHANGE ShiftTo ShiftTo INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tauditlog CHANGE id id INT( 10 ) NOT NULL DEFAULT '0', CHANGE rid rid INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tcommand CHANGE c_key c_key INT( 10 ) NOT NULL DEFAULT '0', CHANGE c_gid c_gid INT( 10 ) NOT NULL DEFAULT '0', CHANGE c_retry c_retry INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tconfig CHANGE maxuser maxuser INT( 10 ) NOT NULL DEFAULT '0', CHANGE minvid minvid INT( 10 ) NOT NULL DEFAULT '0', CHANGE maxvid maxvid INT( 10 ) NOT NULL DEFAULT '0', CHANGE tsockport tsockport INT( 10 ) NOT NULL DEFAULT '0', CHANGE csockport csockport INT( 10 ) NOT NULL DEFAULT '0', CHANGE polltime polltime INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tenter CHANGE g_id g_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_id e_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_group e_group SMALLINT( 5 ) NOT NULL DEFAULT '0', CHANGE ed ed INT( 10 ) NOT NULL AUTO_INCREMENT , CHANGE p_flag p_flag INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tgate CHANGE floor floor INT( 10 ) NOT NULL DEFAULT '0', CHANGE tgate.exit tgate.exit TINYINT( 1 ) NOT NULL DEFAULT '0', CHANGE antipass antipass INT( 10 ) NOT NULL DEFAULT '0', CHANGE antipass_level antipass_level INT( 10 ) NOT NULL DEFAULT '0', CHANGE antipass_mode antipass_mode INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tgatelog CHANGE id id INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tgroup CHANGE FlexiBreak FlexiBreak INT( 10 ) NOT NULL DEFAULT '0', CHANGE NightFlag NightFlag TINYINT( 1 ) NOT NULL DEFAULT '0', CHANGE ShiftTypeID ShiftTypeID INT( 10 ) NOT NULL DEFAULT '0', CHANGE ScheduleID ScheduleID INT( 10 ) NOT NULL DEFAULT '0', CHANGE WorkMin WorkMin INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "UPDATE Access.tgroup SET tgroup.NightFlag = '1' WHERE tgroup.NightFlag = '-1'";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.transact CHANGE Transactdate Transactdate INT( 10 ) NOT NULL DEFAULT '0', CHANGE Transacttime Transacttime INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tuser CHANGE padmin padmin INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id SMALLINT( 5 ) NOT NULL DEFAULT '0', CHANGE antipass_state antipass_state INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tvisited CHANGE id id INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id SMALLINT( 5 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.tvisitor CHANGE group_id group_id SMALLINT( 5 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.UserMaster CHANGE Lastlogin Lastlogin INT( 10 ) NOT NULL DEFAULT '0' ";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE Access.WeekMaster CHANGE WeekNo WeekNo INT( 10 ) NOT NULL DEFAULT '0', CHANGE e_id e_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE LogDate LogDate INT( 10 ) NOT NULL DEFAULT '0', CHANGE Seconds Seconds INT( 10 ) NOT NULL DEFAULT '0', CHANGE LastWeekMasterID LastWeekMasterID INT( 10 ) NOT NULL DEFAULT '0', CHANGE group_id group_id INT( 10 ) NOT NULL DEFAULT '0', CHANGE Flag Flag VARCHAR( 10 ) NOT NULL DEFAULT 'Black'";
    safeUpdate($conn, $query, true);
...
function V1265438($conn) { 
    ...
    $query = "ALTER TABLE Transact CHANGE Transactquery Transactquery VARCHAR(1024) NOT NULL";
    safeUpdate($conn, $query, true);
...
function V154934($conn) {
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE tgate CHANGE tgate.exit tgate.exit INT(1) NOT NULL DEFAULT '0', ADD antipass VARCHAR(255) NULL, ADD antipass_level VARCHAR(255) NULL, ADD antipass_mode VARCHAR(255) NULL";
    safeUpdate($conn, $query, true);
    ...
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE OtherSettingMaster CHANGE FlagReportText FlagReportText VARCHAR(1024) NOT NULL DEFAULT ''";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE UserMaster ADD PRIMARY KEY (Username)";
    safeUpdate($conn, $query, true);
    $query = "ALTER TABLE UserMaster CHANGE UserStatus UserStatus VARCHAR(1024) NOT NULL DEFAULT ''";
    safeUpdate($conn, $query, true);
